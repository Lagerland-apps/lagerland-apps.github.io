...
who_not_for:
  ...
  - "You want App Store Preview video assets (ScreenFlow Studio handles still screenshots, not video)"
...
how_it_works:
  ...
  steps:
    - title: "Drop your raw screenshots in"
      detail: "Bulk-import screenshots organised by language and device size from a folder, or drag them in one at a time. ScreenFlow Studio detects resolution and routes each image to the correct device class."
    ...
    - title: "Localise overlaid text into 39 App Store locales"
      detail: "ScreenFlow Studio's AI translation pass localises every overlaid text element in place — preserving fonts, positioning, and right-to-left scripts — for any combination of the 39 locales App Store Connect accepts. You bring your own API key; nothing is routed through a Lagerland server."
...
features:
  ...
  - title: "Direct App Store Connect upload"
    description: "Authenticated via Apple's secure framework. ScreenFlow Studio submits each screenshot to the correct device size × locale slot. Credentials stay in Keychain — never routed through a Lagerland server."
  ...
  - title: "Bulk import and smart templates"
    description: "Drop a folder of raw screenshots organised by language and device — ScreenFlow Studio routes each file to the right slot. Start from professional templates or build custom layouts from scratch."
...
screenshots:
  - src: "/assets/screenshots/screenflow-studio/1.png"
    caption: "ScreenFlow Studio's 3D Metal renderer composing a real device frame on Mac."
  - src: "/assets/screenshots/screenflow-studio/2.png"
    caption: "Percentage-based layout editor — one project, every device size."
  - src: "/assets/screenshots/screenflow-studio/3.png"
    caption: "AI translation pass localising overlaid text in-place across 39 App Store locales."
  - src: "/assets/screenshots/screenflow-studio/4.png"
    caption: "Bulk import: drop a folder organised by language and device, ScreenFlow Studio routes each file."
  - src: "/assets/screenshots/screenflow-studio/5.png"
    caption: "Render preview — what you see is what App Store Connect receives, byte-for-byte."
  - src: "/assets/screenshots/screenflow-studio/6.png"
    caption: "Direct App Store Connect upload by device size and locale. Credentials stay in Keychain."
  - src: "/assets/screenshots/screenflow-studio/7.png"
...
privacy:
  ...
  app_privacy_label: "Apple's App Privacy nutrition label lists ScreenFlow Studio as collecting zero data. Pre-release screenshots, project files, and App Store Connect credentials never leave your Mac for a Lagerland server."
  notes:
...
release_notes:
  ...
  - date: "2026-02-01"
    note: "ScreenFlow Studio 1.0 — native macOS, 3D Metal device-frame rendering, bulk import, professional templates."
...
faq:
  ...
  - q: "Does ScreenFlow Studio handle App Store Preview videos?"
    a: "No — ScreenFlow Studio focuses on still screenshots, the highest-leverage App Store asset. App Store Preview video is a separate format with different recording, encoding, and submission requirements; we'd rather do screenshots well than spread thin across both."
  - q: "Does ScreenFlow Studio work with Fastlane?"
...
support:
  ...
  url: "/apps/screenflow-studio/support/"
