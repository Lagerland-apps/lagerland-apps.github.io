...
seo:
  ...
  keywords:
    ...
    - standby countdown widget
    - vacation planner iphone
    - trip checklist app
    - event countdown with weather
    - photo countdown app
    - countdown and planner app
    - pregnancy due date countdown
    - retirement countdown app
    - milestone tracker iphone
...
founder:
  ...
  signals:
    ...
    - "Shipped 19 privacy-first Apple apps under Lagerland since 2025"
...
value_points:
  ...
  - title: "Plans that plan themselves"
    description: "Every countdown ships with a smart timeline and checklist. Book transport 30 days out. Pack three days before. Arrive ready, never rushed."
  - title: "Widgets for every screen"
    description: "Home Screen, Lock Screen, and StandBy widgets in every iOS size. Small, medium, large, ring, minimal, timeline — always one glance away."
  - title: "Private by default"
    description: "No ads. No tracking. No account. Your moments stay on your device — quietly, for as long as you want them."

features:
  - title: "Full-bleed photo countdowns"
    description: "Pin a photo to every event and watch it take over the screen. The moment you're waiting for, rendered as a feeling — not a digital stopwatch."
  - title: "Smart Plan Mode"
    description: "Each countdown comes with a timeline and checklist tailored to the event type. Trips get packing lists and transport reminders. Weddings get their own rhythm. Everything arrives on time, without you juggling it."
  - title: "Live weather intelligence"
    description: "See the forecast for the destination as the date approaches. Know before you pack. Premium only."
  - title: "Natural language search"
    description: "Type \"trips in July,\" \"birthdays this month,\" or \"anniversaries in 2027.\" Soon. understands what you mean and finds it in seconds."
...
screenshots:
  ...
  - "/assets/screenshots/soon/2.png"
  - "/assets/screenshots/soon/3.png"
  - "/assets/screenshots/soon/4.png"
  - "/assets/screenshots/soon/5.png"
  - "/assets/screenshots/soon/6.png"
  - "/assets/screenshots/soon/7.png"
...
privacy:
  ...
  notes:
    ...
    - "Event data stored locally on your device"
    - "Photos accessed only through Apple's system picker — only the ones you pick"
    - "Weather requests use approximate location or a place name only"
    - "39 languages supported"

faq:
  - q: "What is Soon.?"
    a: "Soon. is a countdown and planner app for iPhone that turns important moments — trips, weddings, birthdays, anniversaries, and milestones — into living countdowns with photo backgrounds, live weather, smart checklists, and widgets for every screen."
  - q: "What can I count down to?"
    a: "Anything that matters. Trips, weddings, birthdays, anniversaries, graduations, due dates, retirement, moves, concerts, holidays. There's no limit on event types and the checklist adapts to what kind of moment it is."
  - q: "How is Soon. different from TheWait?"
    a: "Soon. is the complete rebuild of TheWait. New name, new icon, new home. It adds Plan Mode with smart timelines and checklists, natural language search, StandBy widgets, calendar sync, memories that return on anniversaries, and 39 languages. If you used TheWait, everything carries over."
  - q: "Is Soon. free?"
