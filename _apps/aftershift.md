...
seo:
  ...
  description: "Shift-aware sleep & recovery for nurses, paramedics, and night staff. Naps count as recovery, caffeine timed to your next shift. Free + Pro."
  keywords:
    - shift work sleep app
    - sleep tracker for shift workers
    - night shift recovery app
    - nurse sleep app
    - shift work fatigue tracker
    - nap tracker shift work
    - rotating schedule sleep app
    - first responder sleep app
    - night shift sleep tracker
    - shift recovery score
    - caffeine timing shift work
    - on-call sleep recovery
    - shift work disorder app
    - DuPont schedule sleep
    - 2-2-3 rotation sleep
    - 4 on 4 off sleep app
    - 12 hour shift sleep tracker
    - paramedic sleep tracker
    - firefighter sleep app
...
who_for:
  ...
  - "You're a nurse, paramedic, firefighter, police officer, pilot, or factory worker tracking recovery"
  - "You rely on naps as actual recovery, not as guilty afterthoughts"
  - "You want caffeine timing tied to your next shift — not a textbook bedtime"
  - "You work a DuPont, Pitman, 2-2-3, 4-on-4-off, or 12-hour rotation and want it understood"
  - "You refuse to hand your health data to advertisers, analytics SDKs, or wellness brokers"

who_not_for:
  - "You work a steady 9-to-5 and a generic sleep app already fits"
  - "You want medical diagnosis or treatment for Shift Work Disorder (talk to a sleep specialist)"
  - "You won't use Apple Health or the Apple Sleep tracking on your iPhone or Apple Watch"
...
value_points:
  - title: "Naps count here"
    description: "Naps aren't failures — they're strategy. AfterShift is the only shift-worker sleep app that treats naps as first-class recovery, factored into your Shift Recovery Score alongside core sleep."
  - title: "Your shifts, your recovery"
    description: "Sleep data analyzed against your actual rotation — DuPont, Pitman, 2-2-3, 4-on-4-off, 12-hour, or on-call. Never compared to a 9-to-5 benchmark."
  - title: "Caffeine timed to your next shift"
    description: "Know when caffeine still helps and when it starts sabotaging your next sleep window. Timed to when you actually work, not a textbook 2 p.m. cutoff."
  - title: "Private by default"
    description: "No ads, no health data selling, no account required. Everything stays on your device. No analytics SDKs, no wellness-broker resale."
...
features:
  ...
  - title: "Calendar shift import"
    description: "Import shifts straight from your phone calendar. AfterShift detects work blocks and builds recovery insights around them — no manual entry, no rebuild every roster change."
  - title: "Trends without overwhelm"
    description: "Weekly and monthly patterns in clear, calm visuals. Export summaries when you need them for a chat with HR, a sleep specialist, or your own diary. No data dumps, no anxiety charts."
...
privacy:
  ...
  notes:
    - "No ads, no health data selling"
    - "No third-party trackers or analytics SDKs"
    - "No account required"
    - "All data stored locally on your device"
    - "Health data never leaves the device unless you choose to export a summary"

faq:
  - q: "What is AfterShift?"
    a: "AfterShift is a sleep and recovery app designed specifically for shift workers. It tracks sleep, naps, and fatigue in the context of your actual work schedule — with a Shift Recovery Score, smart caffeine timing, and fragmentation insights. Unlike generic sleep apps, it does not compare you to a 9-to-5 baseline."

  - q: "Who is AfterShift for?"
    a: "Nurses, paramedics, firefighters, police officers, pilots, factory workers, control-room operators, and anyone working night shifts, rotating schedules, early starts, or on-call hours. If your week includes a DuPont, Pitman, 2-2-3, 4-on-4-off, 12-hour, or swing rotation, AfterShift is built for you."

  - q: "How is AfterShift different from OffShift, ShiftSleep, Timeshifter, or generic sleep apps?"
  ...
  - q: "Does AfterShift give medical advice?"
