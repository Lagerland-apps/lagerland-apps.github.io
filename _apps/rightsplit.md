...
screenshots:
  - "/assets/screenshots/rightsplit/1.png"
  - "/assets/screenshots/rightsplit/2.png"
  - "/assets/screenshots/rightsplit/3.png"
  - "/assets/screenshots/rightsplit/4.png"
...
faq:
  - q: "What is RightSplit?"
    a: "RightSplit is a bill splitting app that scans receipts, detects items automatically, and calculates what each person owes — including shared dishes, tip, and rounding. Share payment requests instantly via text or WhatsApp."
  - q: "How does the receipt scanner work?"
    a: "Take a photo of your receipt and RightSplit reads the items and prices automatically. No manual typing required — it detects line items, totals, and tax."
  - q: "Can I split shared dishes?"
    a: "Yes. Any item can be split between multiple people — bottles, appetizers, shared plates. Each person's share is calculated proportionally."
  - q: "How do I send people their share?"
    a: "After splitting, tap to share via text message, WhatsApp, or copy the summary to paste into any app. Each person gets a clear breakdown of what they owe."
  - q: "Is RightSplit free?"
    a: "Yes. Equal splitting, tip calculation, and basic features are free. Pro unlocks item-based splitting, uneven splits, per-person tip breakdown, and split history — from $1.99/year or $7.99 lifetime."
  - q: "Does RightSplit need an account?"
    a: "No. RightSplit works immediately with no sign-up, no account, and no personal information required."
  - q: "Does RightSplit store my receipts online?"
    a: "No. All receipt and bill data stays on your device. RightSplit has no servers, no cloud storage, and no data collection."
