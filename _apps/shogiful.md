...
Everything runs on your device. There is no cloud, no account, no daily quota from a server, no ads. The trade-off is that Shogiful does not offer online play against humans — for that, Shogi Wars, Lishogi, and 81Dojo remain the right tools, and the [side-by-side comparison](#compare-heading-shogiful) is honest about it. Shogiful is the practice room, not the arena.
