...
release_notes:
  ...
  - date: "2026-02-18"
    note: "60-day rolling baseline added for HRV (SDNN), RHR, sleep efficiency, deep-sleep share, REM share."
  - date: "2026-01-01"
...
seo:
  ...
  keywords:
    ...
    - HRV insights app
    - SDNN HRV tracker iPhone
    - RMSSD ECG analysis iPhone
...
hero:
  ...
  subheadline: "Observa reads your Apple Health and Apple Watch data — sleep stages, HRV (SDNN), ECG, resting heart rate — and explains in plain English what actually moves your sleep quality, recovery readiness, and energy. Personal baselines. On-device. No account."
...
how_it_works:
  ...
  steps:
    - title: "Reads from Apple Health"
      detail: "On first launch, Observa requests read access to sleep stages, HRV (SDNN), ECG, resting heart rate, workouts, mindfulness, and active energy. No writes. No background sync to anything but your own device."
    - title: "Builds your personal baseline (60 days)"
      detail: "For every metric Observa tracks (HRV (SDNN), RHR, sleep efficiency, deep-sleep share, REM share), it computes a rolling 60-day mean and standard deviation. New days are scored against your baseline, not a population average."
...
example_insights:
  ...
  cards:
    ...
    - headline: "Your HRV recovers fast — within reason."
      body: "After a high-strain day, your HRV (SDNN) returns to baseline within 36 hours. Two-day clusters break the pattern."
      tag: "HRV · Recovery"
    ...
    - headline: "Two rest days a week beat one."
      body: "Weeks with two non-consecutive rest days show a +12% HRV (SDNN) baseline vs single-rest-day weeks. n=8 weeks."
...
features:
  ...
  - title: "HRV & ECG recovery readiness"
    description: "Tracks HRV (SDNN, the time-domain metric Apple Health records) against your baseline, computes RMSSD and pNN50 from your Apple Watch ECG recordings, and reads ECG sinus-rhythm data to estimate autonomic recovery state in plain language — not a graph."
...
screenshots:
  ...
  - src: "/assets/screenshots/observa/2.png"
    caption: "Personal 60-day baseline view for HRV (SDNN), resting heart rate, and sleep efficiency."
...
faq:
  ...
  - q: "Does Observa work with Apple Watch?"
    a: "Yes. Observa reads data collected by Apple Watch through Apple Health — including heart rate, HRV (SDNN), ECG, sleep stages, resting heart rate, wrist temperature, and activity metrics. No separate pairing needed. ECG insights require Apple Watch Series 4 or later; HRV and sleep work on Series 3 and later."
  ...
  - q: "What are HRV and ECG insights?"
    a: "Observa tracks HRV (SDNN, the time-domain metric Apple Health provides) against your personal 60-day baseline, flags drops greater than one standard deviation, and uses Apple Watch ECG recordings — from which it also computes RMSSD and pNN50 — together with ECG sinus-rhythm data to estimate autonomic recovery state — the balance between sympathetic ('fight-or-flight') and parasympathetic ('rest-and-digest') activity. Translation: instead of a graph, you get a sentence like 'Your nervous system is 18% below baseline today — likely a recovery day.'"
  - q: "Is Observa free?"
