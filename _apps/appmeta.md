...
founder:
  ...
  signals:
    - "Same tool Lagerland uses to ship every release of all 17 apps in the catalogue"
  ...
  external_link:
    label: "See the 15 Lagerland apps shipped with AppMeta →"
    href: "/apps/"
