...
seo:
  ...
  description: "Most sleep apps assume a 9-to-5. AfterShift is for nurses, pilots, and shift workers whose sleep keeps moving — why rotating schedules need new design."
  keywords:
