...
The [journal index](/journal/) lists every post in reverse chronological order. Nothing social, no comments, no newsletter sign-up wall. If you want to get in touch, [email me](mailto:lagerland.apps@proton.me). If you want to support the work, [download an app you'd actually use](/apps/).
