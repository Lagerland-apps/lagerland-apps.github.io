...
seo:
  ...
  description: "Apple Health is the biggest passive health dataset you'll own. Which questions 14 days of data can answer, which need 60 days, and which it cannot."
  keywords:
    - "apple health data"
